...
class AiProvider extends ChangeNotifier {
  ...
  //   if (sessionId == null) {
  //     debugPrint("Session ID is null while sending message!");
  //     return;
  //   }
  //
  ...
  //     );
  //
  //     // Add placeholder for assistant message with loading true
  //     messages.add({
  //       "sender": "assistant",
  ...
  //     notifyListeners();
  //
  //     // After response, replace the loading message with actual reply
  ...
  //   notifyListeners();
  //
  //   // ➡️ Add placeholder for assistant message with loading true BEFORE calling API
  //   messages.add({
  //     "sender": "assistant",
  //     "content": "", // empty initially
  //     "createdAt": DateTime.now().toIso8601String(),
  ...
  //     debugPrint("Error in sendMessage: $e");
  //
  //     // Remove shimmer message if error occurred
