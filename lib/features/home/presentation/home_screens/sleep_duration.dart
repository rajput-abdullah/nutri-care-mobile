...
class SleepDuration extends StatefulWidget {
  const SleepDuration({super.key});

  @override
  State<SleepDuration> createState() => _SleepDurationState();
}

class _SleepDurationState extends State<SleepDuration> {
  @override
                                ...
                                Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      children: [
                                        CustomText(
                                          text: "This chart shows how close you followed Your target bedtime schedule. Aim to get in and out of bad within 30 minutes of your target.",
                                          fontWeight: FontWeight.w500,
                                          fontSize: sizes?.fontSize12,
                                          lines: 4,
                                          fontFamily: 'Inter Tight',
