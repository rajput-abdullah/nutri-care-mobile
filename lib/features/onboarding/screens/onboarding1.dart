          ...
          child: Column(
            children: [
              ...
              Align(
                alignment: Alignment.center,
                child: Text(
                  "Fuel your body the right way. Share your dietary needs, \npreferences, and goals to unlock meal recommendations tailored\n to your lifestyle.",
                  textAlign: TextAlign.center,  // Add this line for right text alignment
                  style: TextStyle(
